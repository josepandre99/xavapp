...
<html>
  <head>
    ...
    <title><?php print($doc_title); ?> | Kegiatan</title>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="#">Tahun Kegiatan</a></li>
            <li class="active">Tahun Kegiataan Aktif</li>
          </ol>
        </section>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Tambah Tahun Kegiatan</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="POST" action="<?php echo (base_url() . 'tahun_kegiatan/tambah');?>">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="inputTahun">Tahun</label>
                      <input type="number" class="form-control" id="inputTahun" name="inputTahun" placeholder="Enter Tahun">
                    </div>
                  </div><!-- /.box-body -->
            ...
            <div class="col-md-6">
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Tahun Kegiatan Aktif</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form"  method="POST" action="<?php echo (base_url() . 'tahun_kegiatan/activate');?>">
                  <div class="box-body">
                    <!-- select -->
                    <div class="form-group">
                      <label>Ubah Tahun Kegiatan Aktif</label>
                      <select class="form-control select2" id="selectedTahun" name="selectedTahun">
                        <?php
